  ...
  return (
    <>
      <div className="bg-white-A700 flex flex-col font-inter items-center justify-end mx-auto w-full">
        ...
        <div className="h-[2820px] sm:h-[3883px] md:h-[4573px] max-w-[1592px] mx-auto md:px-5 relative w-full">
          <div className="absolute flex flex-col md:gap-10 gap-80 inset-x-[0] justify-start mx-auto top-[0] w-full">
            <div className="h-[2375px] sm:h-[3553px] md:h-[4523px] relative w-full">
              <div className="absolute h-[2372px] sm:h-[3553px] md:h-[4523px] inset-[0] justify-center m-auto w-full">
                <div className="absolute h-[2347px] sm:h-[3553px] md:h-[4523px] inset-[0] justify-center m-auto w-full">
                    ...
                    <div className="flex flex-col gap-[26px] justify-start mt-[39px] w-[78%] md:w-full">
                      ...
                      <div className="flex flex-col justify-start w-full">
                        ...
                        >
                          ...
                          <div className="sm:h-[254px] h-[255px] md:h-[615px] relative w-full">
